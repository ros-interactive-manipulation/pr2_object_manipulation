...
if(DOXYGEN_FOUND)
  ...
  find_file(DOXYFILE_IN "Doxyfile.in"
    PATHS "${PROJECT_SOURCE_DIR}/doc" "${CMAKE_CURRENT_SOURCE_DIR}" "${CMAKE_ROOT}/Modules/"
    NO_DEFAULT_PATH
...
if(DOXYGEN_FOUND AND DOXYFILE_IN_FOUND)
  usedoxygen_set_default(PROJECT_NAME "FgBgSegment" 
    PATH "Project name")
  ...
  usedoxygen_set_default(DOXYFILE_EXTRA_SOURCES "${CMAKE_CURRENT_SOURCE_DIR}/pyra" STRING "Additional Source directories")
